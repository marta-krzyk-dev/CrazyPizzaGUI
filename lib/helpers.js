...
helpers.validatePizzas = function (pizzaArray) {
    ...
    pizzaArray.forEach(function (element) {
        ...
        const menuPizza = menu.find(pizza => pizza.Id == element.id);
        ...
        element.pizzaName = menuPizza.Name;
        element.Price = menuPizza.Price;
        element.totalPrice = element.amount * menuPizza.Price;
    });
